...
export const QuestionService = {
  fetch(params) {
    return ApiService.query("questions", params)
  },
  get:(slug) => ApiService.get("questions", slug),
  create:(params) =>  ApiService.post("questions", params),
  update:(slug, params)=> ApiService.update("questions", slug, params),
  delete:(slug) => ApiService.delete(`questions/${slug}`),
};

export const CommentsService = {
  fetch:(params) => ApiService.query(`comments?`,  params),
  get(slug)  {
    return ApiService.get("comments", slug);
  },
  post:(payload) => ApiService.post(`comments/`,  payload ),
  update:(slug, payload) => ApiService.update(`comments/`,slug,  payload ),
  delete:(slug) => ApiService.delete(`comments/${slug}`)
};
